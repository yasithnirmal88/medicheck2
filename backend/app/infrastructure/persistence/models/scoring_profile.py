...
class ScoringProfileModel(BaseModel):
    ...
    weights: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=dict)
    thresholds: Mapped[dict | None] = mapped_column(JSON, nullable=True, default=list)
