...
class ImagingTestModel(BaseModel):
    ...
    modality: Mapped[str] = mapped_column(String(50), nullable=False, default="X-ray")
    is_contrast_required: Mapped[bool] = mapped_column(
